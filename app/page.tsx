    ...
    <main>
      <div className="page-shell">
        <header className="home-hero">
          <h1 className="hero-title">Chanmin Kim</h1>
          <p className="bio-text hero-summary">A pharmacy student and builder wandering in search of something only I can do</p>
          <p className="contact-row hero-contact">
